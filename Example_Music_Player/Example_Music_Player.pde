...
void setup() 
{
  ...
  song1 = minim.loadFile("Ghost_Walk.mp3"); //able to pass absolute path, file name & extension, and URL
}//End setup
//
void draw() {
...
{
  //First Play Button
  if ( key=='k' || key=='K' ) song1.play(); //Parameter is milli-seconds from start of audio file to start playing
  //
